...
public class Item extends LinearLayout {
    ...
    protected void initLayout() {
        V.LP(this).paddingDP(8).orientation(0).gravity(Gravity.CENTER).backgroundRes(R.drawable.bg_cdk);
    ...
    protected void initAttrs(AttributeSet attrs) {
        try (TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CDKItem)) {

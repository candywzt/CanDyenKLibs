...
public class TextUtil {
     ...
     * <br>给文本换个颜色(十六进制颜色值)
     */
    public TextUtil addColor(int start, int end, int color) {
        if (span.length() == 0) {
            return this;
        } else if (end == 0) {
            end = span.length();
     ...
     */
    public TextUtil addBackgroundColor(int start, int end, int color) {
        if (span.length() == 0) {
            return this;
        } else if (end == 0) {
            end = span.length();
    ...
    public TextUtil addTypeFont(int start, int end, Typeface typeface) {
        if (span.length() == 0) {
            return this;
        } else if (end == 0) {
            end = span.length();
     ...
     */
    public TextUtil addSize(int start, int end, int size, boolean dip) {
        if (span.length() == 0) {
            return this;
        } else if (end == 0) {
            end = span.length();
     ...
     */
    public TextUtil addClickable(int start, int end, View.OnClickListener l) {
        if (span.length() == 0) {
            return this;
        } else if (end == 0) {
            end = span.length();
     ...
     * @param radius   标点半径px
     */
    public TextUtil addBulletSpan(int start, int end, int gapWidth, int color, int radius) {
        if (span.length() == 0) {
            return this;
        } else if (end == 0) {
            end = span.length();
    ...
    /**********************************************************************************************/
    //创建
    public static TextUtil CREARE(CharSequence text) {
        new TextUtil();

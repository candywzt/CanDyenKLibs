 ...
 * 放GIF也不是很卡<br>
 */
public class NimbleRelativeLayout extends RelativeLayout {
    ...
    public NimbleRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
